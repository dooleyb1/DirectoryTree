...
extern bool Dflag, inodeflag, devflag, Rflag, duflag, pruneflag, Zflag;
...
off_t fridaytree_listdir(char *d, int *dt, int *ft, u_long lev, dev_t dev)
{
  char *path;
...
off_t fridaytree_rlistdir(char *d, int *dt, int *ft, u_long lev, dev_t dev)
{
  struct _info **dir;
  off_t size = 0;
  char *err;
  ...
  fridaytree_r_listdir(dir, d, dt, ft, lev);

  return size;
}

void fridaytree_r_listdir(struct _info **dir, char *d, int *dt, int *ft, u_long lev)
{
  char *path;
  long pathsize = 0;
